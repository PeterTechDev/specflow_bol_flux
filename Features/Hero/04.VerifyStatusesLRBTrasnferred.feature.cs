...
namespace CreateBolFlow.Features.Hero
{
    ...
    public partial class _04_VerifyStatusesBeforeActionFeature : object, Xunit.IClassFixture<_04_VerifyStatusesBeforeActionFeature.FixtureData>, System.IDisposable
    {
...
#line 1 "04.VerifyStatusesLRBTrasnferred.feature"
#line hidden
        
        public _04_VerifyStatusesBeforeActionFeature(_04_VerifyStatusesBeforeActionFeature.FixtureData fixtureData, CreateBolFlow_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Hero", "04. Verify Statuses Before Action", null, ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
        ...
        [Xunit.TraitAttribute("FeatureTitle", "04. Verify Statuses Before Action")]
        ...
        [Xunit.TraitAttribute("Category", "4")]
        [Xunit.InlineDataAttribute("MNST-GALV-GUST-719-1", "In Transit", "LRBs Assigned", "Pending", "Pending", new string[0])]
...
#line hidden
#line 17
        testRunner.And(string.Format("the Rubicon status should be \"{0}\"", rubiconStatus), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 18
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                _04_VerifyStatusesBeforeActionFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                _04_VerifyStatusesBeforeActionFeature.FeatureTearDown();
            }
        }
    }
}
