...
namespace CreateBolFlow.Features.Hero
{
    ...
    public partial class _14_VerifyStatuses_AfterSuceessfulQualityInspectionFeature : object, Xunit.IClassFixture<_14_VerifyStatuses_AfterSuceessfulQualityInspectionFeature.FixtureData>, System.IDisposable
    {
...
#line 1 "14.VerifyStatusesAfterSuccessfulQc.feature"
#line hidden
        
        public _14_VerifyStatuses_AfterSuceessfulQualityInspectionFeature(_14_VerifyStatuses_AfterSuceessfulQualityInspectionFeature.FixtureData fixtureData, CreateBolFlow_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Hero", "14. Verify Statuses - After Suceessful Quality Inspection", null, ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
        ...
        [Xunit.SkippableTheoryAttribute(DisplayName="14. Verify Statuses - After Suceessful Quality Inspection")]
        [Xunit.TraitAttribute("FeatureTitle", "14. Verify Statuses - After Suceessful Quality Inspection")]
        [Xunit.TraitAttribute("Description", "14. Verify Statuses - After Suceessful Quality Inspection")]
        [Xunit.TraitAttribute("Category", "TestCaseKey=PSP-T39")]
        [Xunit.TraitAttribute("Category", "14")]
        [Xunit.InlineDataAttribute("MNST-GALV-GUST-719-1", "Coating Completed", "Coating Completed", "Passed", "Passed", new string[0])]
        public void _14_VerifyStatuses_AfterSuceessfulQualityInspection(string bolNumber, string rubiconStatus, string heroStatus, string qcStatus, string shippingStatus, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("14. Verify Statuses - After Suceessful Quality Inspection", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 13
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                _14_VerifyStatuses_AfterSuceessfulQualityInspectionFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                _14_VerifyStatuses_AfterSuceessfulQualityInspectionFeature.FeatureTearDown();
            }
        }
    }
}
