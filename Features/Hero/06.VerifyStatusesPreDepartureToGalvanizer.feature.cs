...
namespace CreateBolFlow.Features.Hero
{
    ...
    public partial class _06_VerifyStatuses_BOLPre_DepartureToGalvanizerFeature : object, Xunit.IClassFixture<_06_VerifyStatuses_BOLPre_DepartureToGalvanizerFeature.FixtureData>, System.IDisposable
    {
...
#line 1 "06.VerifyStatusesPreDepartureToGalvanizer.feature"
#line hidden
        
        public _06_VerifyStatuses_BOLPre_DepartureToGalvanizerFeature(_06_VerifyStatuses_BOLPre_DepartureToGalvanizerFeature.FixtureData fixtureData, CreateBolFlow_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Hero", "06. Verify Statuses - BOL Pre-Departure to Galvanizer", null, ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
        ...
        [Xunit.SkippableTheoryAttribute(DisplayName="6. Verify Statuses - BOL PreDeparture to Galvanizer")]
        [Xunit.TraitAttribute("FeatureTitle", "06. Verify Statuses - BOL Pre-Departure to Galvanizer")]
        [Xunit.TraitAttribute("Description", "6. Verify Statuses - BOL PreDeparture to Galvanizer")]
        [Xunit.TraitAttribute("Category", "TestCaseKey=PSP-T33")]
        [Xunit.TraitAttribute("Category", "6")]
        [Xunit.InlineDataAttribute("MNST-GALV-GUST-719-1", "In Transit", "Shipped To Coating Applicator", "Pending", "Passed", new string[0])]
        public void _6_VerifyStatuses_BOLPreDepartureToGalvanizer(string bolNumber, string rubiconStatus, string heroStatus, string qcStatus, string shippingStatus, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("6. Verify Statuses - BOL PreDeparture to Galvanizer", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 13
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                _06_VerifyStatuses_BOLPre_DepartureToGalvanizerFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                _06_VerifyStatuses_BOLPre_DepartureToGalvanizerFeature.FeatureTearDown();
            }
        }
    }
}
