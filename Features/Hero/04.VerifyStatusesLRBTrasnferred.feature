Feature:04. Verify Statuses Before Action
    ...
    Scenario:4. Verify Statuses - BOL after LRBs transfered
        ...
        And the Rubicon status should be "<rubiconStatus>"
    ...
    | MNST-GALV-GUST-719-1 | In Transit    | LRBs Assigned | Pending   | Pending        |
