...
namespace CreateBolFlow.Features.Hero
{
    ...
    public partial class _07_GalvanizerReceivingFeature : object, Xunit.IClassFixture<_07_GalvanizerReceivingFeature.FixtureData>, System.IDisposable
    {
...
#line 1 "07.GalvanizerReceiving.feature"
#line hidden
        
        public _07_GalvanizerReceivingFeature(_07_GalvanizerReceivingFeature.FixtureData fixtureData, CreateBolFlow_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Hero", "07. Galvanizer Receiving", null, ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
        ...
        [Xunit.TraitAttribute("FeatureTitle", "07. Galvanizer Receiving")]
        [Xunit.TraitAttribute("Description", "7. Galvanizer Receiving")]
        [Xunit.TraitAttribute("Category", "TestCaseKey=PSP-T34")]
        [Xunit.TraitAttribute("Category", "7")]
        [Xunit.InlineDataAttribute("MNST-GALV-GUST-719-1", "123", "02/14/2024", "10", "Receive", "BOL received", "In Transit", new string[0])]
        public void _7_GalvanizerReceiving(string bolCode, string internalJobNumber, string completionDate, string piecesReceived, string pageTitle, string sucessMessage, string rubiconStatus, string[] exampleTags)
        {
...
#line hidden
#line 18
        testRunner.Then("the user clicks in the button \"Receive\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 19
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                _07_GalvanizerReceivingFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                _07_GalvanizerReceivingFeature.FeatureTearDown();
            }
        }
    }
}
