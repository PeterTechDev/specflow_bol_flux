Feature:06. Verify Statuses - BOL Pre-Departure to Galvanizer
...
| MNST-GALV-GUST-719-1 | In Transit    | Shipped To Coating Applicator | Pending  | Passed         |