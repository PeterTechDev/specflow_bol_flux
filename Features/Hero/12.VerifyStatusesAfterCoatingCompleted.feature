Feature: 12. Verify Statuses - After Coating Completed
    ...
    @TestCaseKey=PSP-T39 @12
    Scenario Outline: 12. Verify Statuses - After Coating Completed
...
| MNST-GALV-GUST-719-1 | Coating Completed | Coating Completed | Pending  | Passed         |