...
namespace CreateBolFlow.Features.Hero
{
    ...
    public partial class _12_VerifyStatuses_AfterCoatingCompletedFeature : object, Xunit.IClassFixture<_12_VerifyStatuses_AfterCoatingCompletedFeature.FixtureData>, System.IDisposable
    {
...
#line 1 "12.VerifyStatusesAfterCoatingCompleted.feature"
#line hidden
        
        public _12_VerifyStatuses_AfterCoatingCompletedFeature(_12_VerifyStatuses_AfterCoatingCompletedFeature.FixtureData fixtureData, CreateBolFlow_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Hero", "12. Verify Statuses - After Coating Completed", null, ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
        ...
        [Xunit.SkippableTheoryAttribute(DisplayName="12. Verify Statuses - After Coating Completed")]
        [Xunit.TraitAttribute("FeatureTitle", "12. Verify Statuses - After Coating Completed")]
        [Xunit.TraitAttribute("Description", "12. Verify Statuses - After Coating Completed")]
        [Xunit.TraitAttribute("Category", "TestCaseKey=PSP-T39")]
        [Xunit.TraitAttribute("Category", "12")]
        [Xunit.InlineDataAttribute("MNST-GALV-GUST-719-1", "Coating Completed", "Coating Completed", "Pending", "Passed", new string[0])]
        public void _12_VerifyStatuses_AfterCoatingCompleted(string bolNumber, string rubiconStatus, string heroStatus, string qcStatus, string shippingStatus, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("12. Verify Statuses - After Coating Completed", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 13
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                _12_VerifyStatuses_AfterCoatingCompletedFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                _12_VerifyStatuses_AfterCoatingCompletedFeature.FeatureTearDown();
            }
        }
    }
}
